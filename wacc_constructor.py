...
class WaccCalculator:
    def __init__(self, tech_premiums, penetration_boundaries, maturity_premiums, exchange_rates, inflation):
        """ Initialises the WACC Calculator Class, which is used to build the underlying data required to calculate the cost of debt and equity for energy investors 
        for a range of technologies and sources of finance
        Inputs:
